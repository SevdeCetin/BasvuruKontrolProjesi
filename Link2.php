...
{ 
  ...
  $sql="INSERT INTO isci (Firma,TC,AdSoyad,Alan,email,Belge1,Belge2,LinkSeviye,onay) 
    VALUES ('$Firma','$TC','$AdSoyAd','$Alan','$email','$Belge1','$Belge2','$LinkSeviye','$onay')";
