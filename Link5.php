...
<div class="card mx-xl-5">
    ...
    <div class="card-body">
        ...
        <form action="" method="POST">
            ...
            <br>
            <!-- Default input name  -->
            <label for="defaultFormCardNameEx" class="grey-text font-weight-light">Belge-5</label>
            <input type="file" name="Belge5" class="form-control">
...
{ 
  ...
  $sql="INSERT INTO isci (Firma,TC,AdSoyad,Alan,email,Belge1,Belge2,Belge3,Belge4,Belge5,LinkSeviye,onay) 
    VALUES ('$Firma','$TC','$AdSoyAd','$Alan','$email','$Belge1','$Belge2','$Belge3','$Belge4','$Belge5','$LinkSeviye','$onay')";
